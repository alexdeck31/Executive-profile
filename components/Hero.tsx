...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-zinc-900 overflow-hidden">
      ...
      {/* Profile Image - Left Side (Adapted to ~40-45% width) */}
      <div className="absolute inset-0 md:w-[45%] lg:w-[40%] z-0">
         <div className="relative w-full h-full">
            ...
            {/* Main fade to background color on the right - Wider gradient (w-64) for softer blend */}
            <div className="absolute inset-y-0 right-0 w-64 bg-gradient-to-r from-transparent to-zinc-900 hidden md:block"></div>
            {/* Subtle darkening for texture */}
            <div className="absolute inset-0 bg-black/5 mix-blend-multiply"></div> 
            {/* Mobile fade from bottom */}
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/80 to-transparent md:hidden"></div>
         </div>
      </div>

      {/* Content Side */}
      <div className="container mx-auto px-4 md:px-6 relative z-10 h-full flex flex-col justify-end md:justify-center pb-20 md:pb-0">
        
        <div className="flex flex-col md:flex-row items-center justify-end w-full">
          
          {/* Glass Card - Overlapping */}
          {/* Adjusted width and margin for the refined image split */}
          <div className="w-full md:w-[60%] lg:w-[65%] relative md:-ml-16 lg:-ml-24 mt-8 md:mt-0 animate-slide-in-right">
            
            {/* Glass Effect Container */}
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/80 backdrop-blur-2xl shadow-[0_40px_80px_rgba(0,0,0,0.6)] p-8 md:p-12">
              ...
              <div className="relative z-10">
                ...
                {/* Updated Subtitle 1: Capabilities Recap */}
                ...
                {/* Updated Subtitle 2: Personal Quote */}
